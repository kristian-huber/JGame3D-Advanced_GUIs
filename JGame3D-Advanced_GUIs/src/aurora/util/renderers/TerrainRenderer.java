...
import aurora.util.shaders.TerrainShader;
...
public class TerrainRenderer {
	...
	public static void render(Terrain terrain, ArrayList<Light> lights) {
		...
		if (terrain != null) {
			...
			shader.connectTextureUnits(terrain.getTexturePack().activeTextures);
			shader.loadLights(lights);
			shader.loadPaint(terrain.paint);
