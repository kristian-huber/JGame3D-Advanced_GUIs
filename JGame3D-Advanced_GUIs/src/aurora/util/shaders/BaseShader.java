...
public abstract class BaseShader {
	...
	public BaseShader(String vertexFile, String fragmentFile) {
		...
		this.fragmentShaderID = BaseShader.loadShader(fragmentFile,
				GL20.GL_FRAGMENT_SHADER);
		this.vertexShaderID = BaseShader.loadShader(vertexFile,
	...
	/* Writes a Vector2f to the Shader */
	protected void loadVector(int location, Vector2f vector) {

		GL20.glUniform2f(location, vector.x, vector.y);
	}

	/* Writes a Vector4f to the Shader */
	...
	private static int loadShader(String file, int type) {
		...
		try {
			...
			BufferedReader reader = new BufferedReader(new InputStreamReader(
					BaseShader.class.getResourceAsStream("/aurora/util/shaders/" + file)));
			String line;
