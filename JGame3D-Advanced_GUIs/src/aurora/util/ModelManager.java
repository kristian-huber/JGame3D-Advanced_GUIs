...
public class ModelManager {
	...
	/* Registers a Basic Object into Memory */
	public static void loadToVao(String ID, float[] positions, int dimensions) {
		...
		ModelManager.MODELS.put(ID, new RawModel(vaoID, positions.length
				/ dimensions));
	}

	/* Registers a 3D Object into Memory */
	...
	/* Loads a RawModel */
	public static void loadLocalModel(String fileName) {
		...
		try {
			...
			System.err.println("Could Not Read File For " + fileName);
		}
	...
	/* Gets a Model Based on its String ID */
